...
if((!isset($_SESSION["Username"]->Username)) || ($_SESSION["Username"]->Account_type != 'Admin')){
...
if(isset($_POST['cat1'])){
	...
	if($reos->num_rows >=1){echo "You cannot add an admin twice";}
	else{
								...
								<tr>
									...
									<th class="total-th">
                                        <form action="" method="post">
                                            ...
                                            <button type="submit" class="site-btn submit-order-btn">Add Admin</button>
                                        </form>
                                    </th>
								</tr>
							</thead>
